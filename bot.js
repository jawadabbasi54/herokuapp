...
const bot = new SlackBot({
  token: 'xoxb-520780954817-520787491121-GQWJTzggBgCvMLLPXPXe1Tlm',
  name: 'abode_bot'
});
...
bot.on('start', () => {
  const params = {
    icon_url: 'https://a.slack-edge.com/ae7f/img/services/jenkins-ci_512.png'
  };
...
function thread_msg(thread_ts, channel, bot_name, fall_msg, colr) {
  ...
  var token= 'token=xoxp-520780954817-522787814374-524847683735-c44c030ee9de6b2393fc44983a2d8b19&';
...
request('https://slack.com/api/bots.info?token=xoxp-520780954817-522787814374-524847683735-c44c030ee9de6b2393fc44983a2d8b19&bot='+bot_id+'&pretty=1', function (error, response, body) {
